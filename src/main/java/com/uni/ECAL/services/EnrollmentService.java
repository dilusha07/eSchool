...
import com.uni.ECAL.repository.EnrollmentRepository;
...
public class EnrollmentService {
    ...
    public Enrollment saveEnrollment(Enrollment enrollment){return enrollmentRepo.save(enrollment);}

    public Enrollment addNewEnrollment(Enrollment enrollment){return enrollmentRepo.save(enrollment);}

    public List<Enrollment> getAllEnrollments(){return (List<Enrollment>) enrollmentRepo.findAll();}
    ...
    public Enrollment fetchByCoursename(String coursename){return enrollmentRepo.findByCoursename(coursename);}

    public Enrollment fethByCourseid(String courseid){
        return enrollmentRepo.findByCourseid(courseid);
    }

    public Enrollment fetchByCourseid(String courseid){return enrollmentRepo.findByCourseid(courseid);}

    public List<Enrollment> fetchByEnrolledusername(String enrolledusername){
        return enrollmentRepo.findByEnrolledusername(enrolledusername);
    }

    public List<Enrollment> fetchByuserid(String  enrolleduserid){
